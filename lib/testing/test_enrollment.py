...
class TestAggregateMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.course2 = Course("History 101")
        self.student.enroll(self.course1)
        self.student.enroll(self.course2)
        self.student._grades = {self.course1: 85, self.course2: 90}  # Adding grades for testing
    ...
    def test_aggregate_enrollments_per_day(self):
        Enrollment(self.student, self.course1)  # Create an enrollment
        Enrollment(self.student, self.course2)  # Create another enrollment
